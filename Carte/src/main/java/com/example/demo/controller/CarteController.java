...
public class CarteController {
	...
	public ResponseEntity<?> mescolaCarte() {
		...
		if (!mescolate) 
    		return new ResponseEntity<>(Collections.singletonMap("status", "non mescolate"), HttpStatus.BAD_REQUEST);
	
			
		LOGGER.info("Carte Mescolate {}", napoletane.getCarte());

	    return new ResponseEntity<>(Collections.singletonMap("status", "mescolate"), HttpStatus.OK);
	}
